...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-teal-100 px-4 relative overflow-hidden">
    ...
    <div class="relative w-full max-w-md z-50">
        ...
        {{-- Glow border --}}
        <div class="absolute -inset-1 bg-gradient-to-r from-teal-400 via-blue-400 to-purple-500 rounded-3xl blur-lg opacity-30"></div>
            ...
            <div class="mt-6 text-center">
                <p class="text-gray-500">
                    ...
                    <a href="/login" class="font-semibold text-teal-600 hover:text-teal-700 relative group">
                        Sign In
                        <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-teal-600 group-hover:w-full transition-all duration-300"></span>
                    </a>
                </p>
            </div>
